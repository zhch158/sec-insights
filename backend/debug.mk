run:
	...
	podman compose create db localstack
	podman compose start db localstack
	poetry run start

run_podman:
	echo "Running in local mode with podman."
	podman compose up

migrate:
	echo "Running migrations."
	podman compose create db
...
setup_localstack:
	podman compose create localstack
	podman compose start localstack
...
seed_db_local:
	...
	# python scripts/seed_db.py --ciks '["0001018724", "1326801", "320193", "789019"]'  --filing_types '["10-K"]'
